...
class _MyBotState extends State<MyBot> {
  void response(query) async {
    AuthGoogle authGoogle = await AuthGoogle(fileJson: "assets/cupcakesbot-qlrcih-9c82160e9e70.json").build();
    Dialogflow dialogflow = Dialogflow(authGoogle: authGoogle, language: Language.english);
    AIResponse aiResponse = await dialogflow.detectIntent(query);
    setState(() {
      messsages.insert(0, {"data": 0, "message": aiResponse.getListMessage()[0]["text"]["text"][0].toString()});
    });
  }
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Flexible(
                    child: Text(
                  message,
                  style: TextStyle(color: Color.fromRGBO(14, 49, 80, 1), fontWeight: FontWeight.bold),
                ))
              ],
            ),
          )),
