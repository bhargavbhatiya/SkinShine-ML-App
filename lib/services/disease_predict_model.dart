...
class _ML_ModelState extends State<ML_Model> {
  ...
  classifyImage(File image) async {
    var output = await Tflite.runModelOnImage(
        path: image.path, imageMean: 0.0, imageStd: 255.0, numResults: 2, threshold: 0.2, asynch: true);
                          ...
                          children: [
                            _image == null
                                ? Container(
                                    ...
                                    child: Text("Choose an Image to predict Disease"),
                                ...
                                : _outputs != null
                                    ? Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: Color.fromRGBO(235, 255, 250, 1),
                                            border: Border.all(
